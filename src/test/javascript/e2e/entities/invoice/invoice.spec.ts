...
describe('Invoice e2e test', () => {
    ...
    it('should load Invoices', () => {
        ...
        expect(invoiceComponentsPage.getTitle()).toMatch(/emallApp.invoice.home.title/);
    });

    it('should load create Invoice page', () => {
        invoiceComponentsPage.clickOnCreateButton();
        invoiceUpdatePage = new InvoiceUpdatePage();
        expect(invoiceUpdatePage.getPageTitle()).toMatch(/emallApp.invoice.home.createOrEditLabel/);
