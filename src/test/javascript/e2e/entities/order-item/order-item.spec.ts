...
describe('OrderItem e2e test', () => {
    ...
    it('should load OrderItems', () => {
        ...
        expect(orderItemComponentsPage.getTitle()).toMatch(/emallApp.orderItem.home.title/);
    });
    ...
    it('should load create OrderItem page', () => {
        ...
        expect(orderItemUpdatePage.getPageTitle()).toMatch(/emallApp.orderItem.home.createOrEditLabel/);
