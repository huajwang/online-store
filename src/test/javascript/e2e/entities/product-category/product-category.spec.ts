...
describe('ProductCategory e2e test', () => {
    ...
    it('should load ProductCategories', () => {
        ...
        expect(productCategoryComponentsPage.getTitle()).toMatch(/emallApp.productCategory.home.title/);
    });
    ...
    it('should load create ProductCategory page', () => {
        ...
        expect(productCategoryUpdatePage.getPageTitle()).toMatch(/emallApp.productCategory.home.createOrEditLabel/);
