...
describe('ProductOrder e2e test', () => {
    ...
    it('should load ProductOrders', () => {
        ...
        expect(productOrderComponentsPage.getTitle()).toMatch(/emallApp.productOrder.home.title/);
    });
    ...
    it('should load create ProductOrder page', () => {
        ...
        expect(productOrderUpdatePage.getPageTitle()).toMatch(/emallApp.productOrder.home.createOrEditLabel/);
