...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        ...
        expect(productComponentsPage.getTitle()).toMatch(/emallApp.product.home.title/);
    });

    it('should load create Product page', () => {
        productComponentsPage.clickOnCreateButton();
        productUpdatePage = new ProductUpdatePage();
        expect(productUpdatePage.getPageTitle()).toMatch(/emallApp.product.home.createOrEditLabel/);
